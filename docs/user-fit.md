...
Fidelis 0.2.0 has one job: let an agent retrieve the original passages from
...
| Your situation | 0.2.0 fit | What you get | Boundary to know |
|---|---|---|---|
...
| User who cannot run Ollama or download the embedding model | No | — | 0.2.0 does not provide a hosted embedding or memory service |
...
| Team needing a shared, centralized memory service | Not yet | — | 0.2.0 is local and single-machine; centralized operation is not a supported contract |
